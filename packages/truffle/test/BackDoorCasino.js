...
contract('BackDoorCasino', () => {
  ...
  beforeEach(async () => (contract = await BackDoorCasino.new('')))
  ...
  describe('presaleMint', () => {
    ...
    it('when valid sign must be minted 5', async () => {
      await truffleAssert.passes(
        contract.presaleMint(5, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.03'),
        })
      )

      assert.equal(await contract.balanceOf(holderOne.address), 5)
    })

    it('when valid sign must be minted 6', async () => {
      await truffleAssert.passes(
        contract.presaleMint(6, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.04'),
        })
      )

      assert.equal(await contract.balanceOf(holderOne.address), 6)
    })
    ...
    it('when valid sign must be minted 1+4', async () => {
      await truffleAssert.passes(
        contract.presaleMint(1, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0'),
    ...
    it('when valid sign must be minted 1+5', async () => {
      await truffleAssert.passes(
        contract.presaleMint(1, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0'),
    ...
    it('when valid sign must be minted 2+3', async () => {
      await truffleAssert.passes(
        contract.presaleMint(2, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0'),
    ...
    it('when valid sign must be minted 2+4', async () => {
      await truffleAssert.passes(
        contract.presaleMint(2, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0'),
    ...
    it('when valid sign must be minted 3+2', async () => {
      await truffleAssert.passes(
        contract.presaleMint(3, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.01'),
    ...
    it('when valid sign must be minted 3+3', async () => {
      await truffleAssert.passes(
        contract.presaleMint(3, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.01'),
    ...
    it('when valid sign must be minted 4+1', async () => {
      await truffleAssert.passes(
        contract.presaleMint(4, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.02'),
    ...
    it('when valid sign must be minted 4+2', async () => {
      await truffleAssert.passes(
        contract.presaleMint(4, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.02'),
    ...
    it('when valid sign must be minted 5+1', async () => {
      await truffleAssert.passes(
        contract.presaleMint(5, validSign, {
          from: holderOne.address,
          value: web3.utils.toWei('0.03'),
